...
| [langzhou](https://github.com/langzhou/siyuan-note)大佬的**行内批注**。(js行内批注已经由官方代替)                                              | [langzhou](https://github.com/langzhou/siyuan-note)<br />   |
| [Zuoqiu-Yingyi](https://github.com/Zuoqiu-Yingyi)大佬的Dark+主题新开窗口的代码。(新开窗口已经由官方代替)                         | [Zuoqiu-Yingyi ](https://github.com/Zuoqiu-Yingyi)     |
...
| 11.**引述块横排看板**   | 本主题还支持利用引述块和超级快横排组合制作看板。                                                                                                                                       |
...
| 20.**段落块自动首行缩进**   | 主题右上角功能按钮开启激活，开启后段落块自动缩进,双击段落块末尾无文本区域单独去除缩进。后续更新：为了方便某些骚操作，列表项支持首行缩进（默认不缩进，在列表段落末尾双击单独缩进）      |
| 21.**列表块区分增强**   | 主题右上角功能按钮开启激活，开启后可以轻松区列表层级，和识别列表中某些情况的超级块                                                                                                     |
...
| 24.**标题下展示父子文档**   | 标题下展示父子文档，点击父子文档连接可跳转，悬浮`◈`可预览。                                                                                                                               |
| 25.**悬浮窗引用、反链上下文定位增强**   | 逻辑是：悬浮窗如果存在单个块（除了标题，因为利用悬浮窗面包屑实现，但标题和超级块是父级关系时，思源面包屑有一定的逻辑缺陷）那么自动前一级内容自动展示，并且反链目标更具体更醒目的高亮。 |
| 26.**悬浮窗放大按钮**   | 思源悬浮窗，在钉住鼠标移动后，悬浮窗顶栏增加一个重复点击切换几个放大内容级别的放大按钮                                                                                                 |
| 27.**长按右键隐藏所有悬浮窗**   | 长按右键隐藏所有悬浮窗，或shift+alt+c 隐藏所有思源悬浮窗口，shift+alt+v 显示所有思源悬浮窗                                                                                             |
| 28.**记忆钉住悬浮窗**   | 记忆钉住悬浮窗，在重启、打开软件时重开悬浮窗。                                                                                                                                         |
| 29.**鼠标中键展开折叠大纲**   | 鼠标中键展开折叠大纲，中键子级折叠父级，中键父级折叠/展开子级                                                                                                                          |
