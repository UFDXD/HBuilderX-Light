...
function createHBuiderXToolbar() {
    ...
    HBuiderXToolbar.style.marginRight = "14px";
    HBuiderXToolbar.style.marginLeft = "11px";
}
...
function rightHoverBlock_close() {
    ...
    RightHoverBlock.style.zIndex = "99";
...
function collapseExpand_Head_List() {
    ...
    setInterval(() => {
        ...
        for (let index = 0; index < H.length; index++) {
            const element = H[index].firstElementChild;
        ...
        for (let index = 0; index < NodeListItem.length; index++) {
            const element = NodeListItem[index].children[1].firstElementChild;
            myRemoveEvent(element, "mousedown", _collapseExpand_NodeHeading);
            myRemoveEvent(element, "mousedown", _collapseExpand_NodeListItem);
...
*/
    ...
    function _collapseExpand_NodeListItem(element) {
        ...
        /*  if (elementParentElement.getAttribute("data-type") == "NodeHeading" && elementParentElement.getAttribute("fold") == 1) {
              ...
              var prr=elementParentElement.previousElementSibling;
              if(prr.className=="protyle-action protyle-action--task"){
                  protyle_gutters_click(element);
              }else{
                  commonMenu_click(prr);
              }
          }*/
    ...
    function commonMenu_click(element) {
        ...
        if (elementParentElementParentElement.className == "protyle-wysiwyg protyle-wysiwyg--attr") {
            if (elementParentElementParentElement.firstElementChild.getAttribute("data-node-id") == data_node_id) {
                var i = 0;
...
function HBuiderXThemeToolbarAddButton(ButtonID, ButtonTitle, NoButtonSvgURL, OffButtonSvgURL, NoClickRunFun, OffClickRunFun, Memory) {
    ...
    if (HBuiderXToolbar == null) {
        ...
        if (toolbarEdit == null && windowControls != null) {
            ...
            HBuiderXToolbar.style.paddingTop = "5px";
            HBuiderXToolbar.style.marginRight = "14px";
            HBuiderXToolbar.style.marginLeft = "11px";
        }
    }
